        ...
        <div className="bienvenidos__container">
            <Jumbotron className="bienvenidos__jumbotron" >
                    ...
                    <p className="bienvenidos__texto">
                        ...
                        Nuestros Abogados y Gestores forman parte de un gran equipo de especialistas.<br></br> La gran mayoría son de origen extranjero, por lo que nuestra empatía con el cliente es especial. Esto nos ha llevado a saber qué herramientas y alternativas debemos brindarte, además de conocer cuáles son las principales inquietudes de cualquier ciudadano extranjero.
