        ...
        <div className="banner__mobile__container"> 
            <Carousel>
                ...
                <Carousel.Item>
                    ...
                    <Carousel.Caption>
                    <h1 className="banner__item__title">Nacionalidad  Reagrupación familiar</h1>
                    <p className="black">¿Llevas varios años en España de manera regular? Solicita tu Nacionalidad de la mano de expertos</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img
